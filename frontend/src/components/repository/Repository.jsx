...
const Repository = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch('https://user-live.onrender.com/api/users/credential-repo', {
          method: 'POST',
  ...
  const handleUpdate = async (index) => {
    ...
    try {
      ...
      const response = await fetch('https://user-live.onrender.com/api/users/credential-repo/update-credential', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
